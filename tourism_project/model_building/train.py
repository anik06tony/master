...
Xtrain_path = "hf://datasets/Anikettony/Tourism-Package-Prediction/Xtrain.csv"
Xtest_path = "hf://datasets/Anikettony/Tourism-Package-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/Anikettony/Tourism-Package-Prediction/ytrain.csv"
ytest_path = "hf://datasets/Anikettony/Tourism-Package-Prediction/ytest.csv"
...
categorical_features = [
    'TypeofContact', 'Occupation', 'Gender', 'ProductPitched',
       'MaritalStatus', 'Designation'        # Country where the customer resides
]
...
# Save best model
joblib.dump(best_model, "tourism_model.joblib")

# Upload to Hugging Face
repo_id = "Anikettony/Tourism-Package-Prediction"
repo_type = "model"
...
api.upload_file(
    path_or_fileobj="tourism_model.joblib",
